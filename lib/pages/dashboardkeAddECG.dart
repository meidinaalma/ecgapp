...
class dashADDECG extends StatefulWidget {
  dashADDECG({@required this.user}) : super();
...
class _dashADDECGPage extends State<dashADDECG> {
    ...
    for (int i = 10; i < panjangdata; i++) {
      if (i % 2 == 0) {
        ...
        TimeOfDay _startTime = TimeOfDay(
            ...
            minute: int.parse(jam.split(":")[1].split("").first));
  ...
  void kirimData() async {
    ...
    if (sensorValue != null) {
      ...
      try {
        ...
        print("response send data ${response.body}");
  ...
  void ambilDataDokter() async {
    ...
    setState(() {
      ...
      print("daftar dokter $daftardokterlist");
    });
  }
        ...
        child:
          ...
          CircleAvatar(
            backgroundImage: NetworkImage(
                '${link}${daftardokterlist[index]["foto_profil"]}'),
            maxRadius: 25,
          ),
          Container(
              child: Flexible(
                  child: Container(
                      ...
                      child: Column(
                          ...
                          children: <Widget>[
                            Text('${daftardokterlist[index]["name"]}',
                                maxLines: 1,
